      ...
      912: (e, t, s) => {
        e.exports = {
          install_in_instance: (e, { parameters: t }) => {
            ...
            (e.modules = n), (e.require = (e) => (n[e] ? n[e] : s(274)(e)));
          },
        };
      },
      314: (e) => {
        e.exports = {
          ...
          install_in_instance: (e, { parameters: t }) => {
            ...
            (e.onchange = (t, s) => {
              ...
              (e._.properties = {});
            for (const n in s) {
              const i = { definition: s[n], listeners: [], value: void 0 };
              e._.properties[n] = i;
              let r = null;
              if (
                ("object" == typeof s[n]
                  ...
                  : "function" == typeof s[n] && ((r = {}), (r.value = s[n]())),
                null === r)
              )
              ...
              if (
                ...
                const i =
                  "string" == typeof s[n].construct ? s[n].construct : n;
                e[n] = t[i];
              }
            }
          },
          ...
          install_in_instance: (e, { parameters: t }) => {
            ...
            e.mixin(i, {
              ...
              sub: (t, s) => {
                ...
                if (i) return i.listeners_.push(s), new n(i.listeners_, s);
      ...
      475: (e) => {
        class t {
          ...
          sub(e) {
            ...
            for (const e in i) n[e] || Object.defineProperty(s, e, i[e]);
            return s;
          }
        }
        e.exports = { Context: t };
          ...
          CategorizedToggleLogger: class extends n {
            ...
            static IMPLEMENTS = {
              [i]: {
                log(e, t, s, n) {
                  const i = s.category;
                  if (this.categories[i]) return this.delegate.log(e, t, s, n);
                },
              },
            };
            on(e) {
        ...
        class a extends n {
            ...
            await new Promise((s) => {
              (t = () => {
                if (0 === this.get_waiting_for_(e).length) {
                  ...
                  return -1 !== e && this.init_listeners_.splice(e, 1), s(), !0;
                }
              }),
          ...
          async maybe_init_(e) {
            ...
            if (0 !== n.length) {
              ...
              t.status = new this.constructor.StatusPending({ waiting_for: n });
  ...
  (s.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t)),
    (() => {
      ...
      async function l(
        ...
        (w.onreadystatechange = () => {
          ...
          w.addEventListener("load", async function (n) {
            ...
            if (n.status && 200 !== n.status) return b(i), r(i);
            {
          ...
          version = function (...e) {
            ...
            return (
              ...
              new Promise((e, s) => {
                ...
                r(i, t.success, t.error, e, s), i.send();
              })
            );
          };
        },
      ...
      const T = "function" == typeof ArrayBuffer,
        x = (e, t) => {
          if ("string" != typeof e) return { type: "message", data: P(e, t) };
          const s = e.charAt(0);
          return "b" === s
            ? { type: "message", data: E(e.substring(1), t) }
            : g[s]
            ? e.length > 1
              ? { type: g[s], data: e.substring(1) }
              : { type: g[s] }
            : m;
        },
        E = (e, t) => {
      ...
      function M(e, t) {
        ...
        let n = 0;
        for (let i = 0; i < t; i++)
          (s[i] = e[0][n++]), n === e[0].length && (e.shift(), (n = 0));
                          ...
                          transform(o, a) {
                            for (s.push(o); ; ) {
                              if (0 === n) {
                                ...
                                if (D(s) < i) break;
                                const e = M(s, i);
                                a.enqueue(x(r ? e : C.decode(e), t)), (n = 0);
                              }
                              if (0 === i || i > e) {
                                a.enqueue(m);
                                break;
      ...
      function we(e, t) {
        ...
        if (Array.isArray(e)) {
          ...
          for (let n = 0; n < e.length; n++) s[n] = we(e[n], t);
          return s;
        }
      ...
      function _e(e, t) {
        ...
        if (Array.isArray(e))
          for (let s = 0; s < e.length; s++) e[s] = _e(e[s], t);
      ...
      class Te extends L {
        ...
        add(e) {
          ...
          if ("string" == typeof e) {
            ...
            s || t.type === ke.BINARY_ACK
              ? ((t.type = s ? ke.EVENT : ke.ACK),
      ...
      class Oe extends L {
        ...
        emit(e, ...t) {
          ...
          const s = { type: ke.EVENT, data: t, options: {} };
          if (
        ...
        ack(e) {
          ...
          let s = !1;
          return function (...n) {
            s || ((s = !0), t.packet({ type: ke.ACK, id: e, data: n }));
          };
        }
        onack(e) {
        ...
        socket(e, t) {
          ...
          return (
            s
              ...
              : ((s = new Oe(this, e, t)), (this.nsps[e] = s)),
            s
          );
        }
        _destroy(e) {
      ...
      const qe = {
          resolve(...e) {
            ...
            for (let n = e.length - 1; n >= -1 && !s; n--) {
              const i = n >= 0 ? e[n] : "/";
              0 !== i.length &&
                ((t = `${i}/${t}`), (s = i.charCodeAt(0) === Ue));
            }
            return (
              (t = Ne(t, !s, "/", Be)), s ? `/${t}` : t.length > 0 ? t : "."
            );
          },
          normalize(e) {
          ...
          basename(e, t) {
            ...
            if (void 0 !== t && t.length > 0 && t.length <= e.length) {
              ...
              return (
                s === n ? (n = o) : -1 === n && (n = e.length), e.slice(s, n)
              );
            }
          ...
          parse(e) {
            ...
            return r > 0 ? (t.dir = e.slice(0, r - 1)) : s && (t.dir = "/"), t;
          },
          sep: "/",
          delimiter: ":",
          win32: null,
        ...
        je = (e) => (
          "gui" === puter.env ||
            ...
            (e && (e.startsWith("/") || e.startsWith("~") || !puter.appID)) ||
              (e = Fe.join("~/AppData", puter.appID, e))),
          e
        ),
        ze = function (...e) {
          let t = {};
        ...
        We = function (...e) {
          ...
          return (
            ...
            new Promise(async (e, s) => {
              ...
              (t.source = je(t.source)), (t.destination = je(t.destination));
        ...
        Xe = function (...e) {
          ...
          return (
            ...
            new Promise(async (e, s) => {
              ...
              void 0 !== t.uid
                ? (o.uid = t.uid)
                : void 0 !== t.path && (o.path = je(t.path)),
        ...
        Ve = async function (s, n, i = {}) {
          return new Promise(async (r, o) => {
            ...
            if ("/" === n) return a("Can not upload to root directory.");
            n = je(n);
            const l = t();
            ...
            if (Array.isArray(s) && s.length > 0)
              for (let e = 0; e < s.length; e++)
                (s[e] instanceof DataTransferItem ||
                  s[e] instanceof DataTransferItemList) &&
                  (f = !0);
            if (
              s instanceof DataTransferItemList ||
              s instanceof DataTransferItem ||
              s[0] instanceof DataTransferItem ||
              i.parsedDataTransferItems
            )
              (h = i.parsedDataTransferItems
                ? s
                : await puter.ui.getEntriesFromDataTransferItems(s)),
                h.sort((e, t) =>
              ...
              h = [new File([s], i.name, { type: "application/octet-stream" })];
              for (let e = 0; e < h.length; e++)
                (h[e].filepath = h[e].name), (h[e].fullPath = h[e].name);
            } else {
              if ("string" != typeof s)
              ...
              h = [new File([s], "default.txt", { type: "text/plain" })];
              for (let e = 0; e < h.length; e++)
                (h[e].filepath = h[e].name), (h[e].fullPath = h[e].name);
            }
            let g,
            ...
            for (let e = 0; e < m.length; e++) {
              for (let t = 0; t < b.length; t++)
                !b[t].puter_path_param &&
                  Fe.join(n, b[t].filepath).startsWith(m[e].path + "/") &&
                  (b[t].puter_path_param =
                    `$dir_${e}/` + Fe.basename(b[t].filepath));
              for (let t = 0; t < m.length; t++)
                !m[t].puter_path_param &&
                  m[t].path.startsWith(m[e].path + "/") &&
                  (m[t].puter_path_param =
                    `$dir_${e}/` + Fe.basename(m[t].path));
            }
            for (let e = 0; e < m.length; e++) {
                ...
                JSON.stringify({
                  ...
                  path:
                    (b[e].puter_path_param &&
                      Fe.dirname(b[e].puter_path_param ?? "")) ||
                    (b[e].filepath && Fe.join(n, Fe.dirname(b[e].filepath))) ||
                    "",
        ...
        Qe = function (...t) {
          let s;
          return (
            (s = { app_uid: t[0], items: t[1], success: t[2], error: t[3] }),
            new Promise(async (t, r) => {
              ...
              a.addEventListener("load", async function (n) {
                ...
                if (200 !== this.status)
                  return (
                    s.error && "function" == typeof s.error && s.error(i), r(i)
                  );
                {
                  let e,
                    n = i,
                    r = n.token;
                  if (1 == o.length) e = { ...n.signatures[0] };
                  else {
                    let t = [];
                    for (let e = 0; e < n.signatures.length; e++)
                      t.push({ ...n.signatures[e] });
                    e = t;
                  }
                  return (
                    s.success &&
                      "function" == typeof s.success &&
                      s.success({ token: r, items: e }),
                    t({ token: r, items: e })
                  );
                }
              }),
                ...
                a.send(JSON.stringify({ app_uid: s.app_uid, items: o }));
            })
          );
        },
        Ze = async function (e, t) {
          ...
          const s = Fe.basename(t),
            n = { op: "symlink", path: Fe.dirname(t), name: s, target: e },
            i = new FormData();
          ...
          [et]: {
            stat: async function (e) {
              ...
              if (t && t.stat && t.stat_exp > Date.now()) {
                ...
                ((e) => {
                  for (const t of s) if (r[t] && !e.stat_has[t]) return !1;
                  return !0;
                })(t) && (n = t.stat),
                  e.unlock();
              }
          ...
          [et]: {
            stat: async function (e) {
              ...
              return (
                void 0 !== e.uid
                  ? (i.uid = e.uid)
                  : void 0 !== e.path && (i.path = je(e.path)),
            ...
            readdir: async function (e) {
              ...
              return (
                r(s, void 0, void 0, t.resolve.bind(t), t.reject.bind(t)),
                s.send(JSON.stringify({ path: je(e.path) })),
                await t
              );
            },
          },
      ...
      const at = class {
        ...
        ct = class {
          ...
          send = async (...e) => {
            ...
            "object" == typeof e[0]
              ? ((t = e[0]), (s = 1))
              : ((t = { to: e[0], subject: e[1], body: e[2] }), (s = 3));
              ...
              new Promise((t, s) => {
                ...
                return (
                  ...
                  new Promise((e, t) => {
                    ...
                    r(s, i.success, i.error, e, t), s.send();
                  })
                );
              })
            );
      ...
      class ft extends pt {
        ...
        #i;
        static from(e, t) {
          const s = new ft(t, { target: e.appInstanceID, usesSDK: e.usesSDK });
      ...
      const gt = class extends pt {
              ...
              if (e.data.msg && "focus" === e.data.msg) window.focus();
                ...
                if ("fileOpenPicked" === e.data.msg) {
                  ...
                  "colorPicked" === e.data.msg
                    ...
                    ? this.#a[e.data.original_msg_id](new ht(e.data.saved_file))
            ...
            return new Promise((t) => {
              ...
              if ("app" === this.env)
                ...
                window.open(
                  `${
                    puter.defaultGUIOrigin
                  }/action/show-directory-picker?embedded_in_popup=true&msg_id=${s}&appInstanceID=${
                    this.appInstanceID
            ...
            return new Promise((t) => {
              ...
              if ("app" === this.env)
                ...
                window.open(
                  `${
                    puter.defaultGUIOrigin
                  }/action/show-open-file-picker?embedded_in_popup=true&msg_id=${s}&appInstanceID=${
                    this.appInstanceID
                  }&env=${this.env}&options=${JSON.stringify(e ?? {})}`,
                  o,
                  "toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=" +
            ...
            return new Promise((s) => {
              ...
              if ("app" === this.env)
                ...
                window.open(
                  `${
                    puter.defaultGUIOrigin
                  }/action/show-save-file-picker?embedded_in_popup=true&msg_id=${n}&appInstanceID=${
                    this.appInstanceID
          ...
          launchApp = async function (e, t, s) {
            ...
            const i = await this.#m({
              method: "launchApp",
              callback: s,
              parameters: { app_name: e, pseudonym: n, args: t },
            });
        ...
        wt = class {
          ...
          chat = async (...e) => {
            ...
            s.model && (t.model = s.model),
              ...
              ("o1-mini" !== t.model && "o1-pro" !== t.model) ||
                (t.model = "openrouter:openai/o1-mini"),
              t.model &&
              ...
              !t.model || t.model.startsWith("gpt-")
                ...
                : "claude-3-haiku-20240307" === t.model ||
                  ...
                  "claude-3-7-sonnet-latest" === t.model
                ? (i = "claude")
            ...
            new Promise((e, t) => {
              ...
              window.open(
                ...
                window.addEventListener("message", function (n) {
                  n.data.msg_id == s &&
                    (delete n.data.msg_id,
                    delete n.data.msg,
                    n.data.success
                      ? (puter.setAuthToken(n.data.token), e(n.data))
                      : t(n.data),
                    window.removeEventListener("message", this));
                });
            });
      ...
      class It {
        ...
        hydrate_value_(e) {
          if (e && "object" == typeof e && e.$SCOPE === _t) {
            const { id: t } = e;
            return (...e) => {
              this.target.postMessage({ $SCOPE: _t, id: t, args: e }, "*");
            };
          }
      ...
      class xt {
        ...
        getHydrator({ target: e }) {
          return new It({ target: e });
        }
        registerCallback(e) {
          return this.callbackManager.register_callback(e);
        }
        send(e, t, ...s) {
          e.postMessage({ $SCOPE: _t, id: t, args: s }, "*");
        }
      }
      class Et {
        constructor({ context: e }) {
      ...
      const St = class {
          ...
          async get(e, t) {
            t || (t = e);
            const s = `${e}:${t}`;
            if (this.drivers_[s]) return this.drivers_[s];
            const n = await this.list();
            if (!n[e]) throw new Error(`Interface ${e} not found`);
            return (this.drivers_[s] = new Pt({
              call_backend: new Et({ context: this.context }),
              iface: n[e],
              iface_name: e,
              service_name: t,
            }));
        ...
        static IMPLEMENTS = {
          [et]: {
            ...
            readdir: async function (e) {
              ...
              return (
                this.messageTarget.postMessage(
                  { $: "puter-fs", $callback: s, op: "readdir", args: e },
                  "*"
                ),
                await t
              );
      ...
      class Lt extends $e.concepts.Service {
        ...
        init_top_fs_() {
          ...
          (this.fs_nocache_ = new rt({ api_info: e }).as(et)),
            (this.fs_cache_ = new it({ delegate: this.fs_nocache_ }).as(et)),
            (this.fs_proxy_ = new tt({ delegate: this.fs_nocache_ })),
        ...
        switch (e.packetType) {
          ...
          case 5:
            (t += 2),
              e.password && (t += 6),
              e.puterAuth &&
                ((e.passwordEncoded = zt.encode(e.puterAuth)),
      ...
      let Gt,
        Kt = { server: "wss://puter.cafe/", handler: void 0 };
      class Yt extends pt {
        _events = new Map();
        _streamID;
        constructor(e, t) {
          ...
          const s = {
            ...
            closeCallBack: (e) => {
              if (2 !== e)
                return (
                  this.emit("error", new Error(Wt[e])),
        ...
        write(e, t) {
          if (e.buffer) Kt.handler.write(this._streamID, e), t && t();
          else if (e.resize)
            ...
            Kt.handler.write(this._streamID, Vt.encode(e)), t && t();
          }
        }
        close() {
      ...
      class Qt {
              ...
              (this._ws.onmessage = (e) => {
                const n = (function (e) {
                  ...
                  switch (s) {
                    ...
                    case 5:
                      ...
                      return { packetType: s, streamID: n, infoObj: i };
                  }
                ...
                switch (n.packetType) {
                  ...
                  case 5:
                    t &&
                      this._ws.send(
                        Xt({ packetType: 5, streamID: 0, puterAuth: t })
                      );
                }
              });
          };
        ...
        write(e, t) {
          ...
          s.buffer > 0
            ? (s.buffer--,
              this._ws.send(Xt({ packetType: 2, streamID: e, payload: t })))
            : s.queue.push(t);
        }
        close(e) {
          this._ws.send(Xt({ packetType: 4, streamID: e, reason: 2 }));
        }
      }
      class Zt extends pt {
      ...
      const Jt = ({ Socket: e, DEFAULT_PORT: t }) => {
        const s = {
          request: (s, n) => {
            ...
            const m = {
                data: (e) => {
                  ...
                  for (let e = 1; e < s.length; e++) {
                    const [t, ...n] = s[e].split(":");
                    t &&
                      (c.headers[t.toLowerCase().trim()] = n.join(":").trim());
                  }
                  if (g)
            ...
            let k = [];
            s.data && k.push(s.data), (o = new e(s.hostname, s.port ?? t));
            ...
            return (
              o.on("close", () => {
                if (x) console.error("close event after closed");
                else {
                  if (((x = !0), l)) {
      ...
      class $t {
        ...
        async exec(...e) {
          const t = puter.fs.socket,
            ...
            i = async (e) => {
              const r = await s;
              e.id === r && (n.resolve(e), t.off("submission.done", i));
            };
      ...
      const es = class {
        ...
        convert = async (...e) => {
          ...
          if ("object" == typeof e[0] && null !== e[0])
            ...
            if (e.length < 2)
              throw new Error(
                "usage: convert({ source, dest, from, to }) or convert(source, dest)"
              );
            s.source = e.shift();
            const t = e.shift();
            if (!t.includes("."))
              throw new Error("cannot infer type for: " + e[1]);
            (s.to = ((e) => e.slice(e.lastIndexOf(".") + 1))(t)), (s.dest = t);
          }
      ...
      (window.puter = (function () {
        const e = new (class {
          ...
          constructor(e) {
            (e = e ?? {}), (this.modules_ = []);
            const t = new $e.libs.context.Context().follow(this, [
              "env",
              "util",
              "authToken",
              "APIOrigin",
            ...
            (t.puter = this),
              (this.services = new $e.system.ServiceManager({ context: t })),
              (this.context = t),
              (t.services = this.services);
            let s = new URLSearchParams(window.location.search);
            s.has("puter.app_instance_id")
              ? (this.env = "app")
              ...
              s.has("puter.args")
                ? (this.args = JSON.parse(
                    decodeURIComponent(s.get("puter.args"))
                  ))
                : (this.args = {}),
              s.has("puter.app_instance_id") &&
              ...
              s.has("puter.parent_instance_id") &&
                (this.parentInstanceID = decodeURIComponent(
                  s.get("puter.parent_instance_id")
                )),
              s.has("puter.app.id") &&
                (this.appID = decodeURIComponent(s.get("puter.app.id"))),
              this.appID && (this.appDataPath = `~/AppData/${this.appID}`),
              (this.APIOrigin = this.defaultAPIOrigin),
              s.has("puter.api_origin") && "app" === this.env
                ? (this.APIOrigin = decodeURIComponent(
                    s.get("puter.api_origin")
                  ))
                : s.has("puter.domain") &&
                  "app" === this.env &&
                  (this.APIOrigin = "https://api." + s.get("puter.domain"));
            let n = new $e.libs.log.ConsoleLogger();
            n = new $e.libs.log.CategorizedToggleLogger({ delegate: n });
            const i = n;
            if (
              ((this.log = new $e.libs.log.LoggerFacade({ impl: n, cat: i })),
